      ...
      <div className="overflow-y-auto max-h-[400px] pr-2 custom-scrollbar">
        <div className="grid grid-cols-1 gap-3 mb-10">
          {cartItems.map((item) => {
            ...
            const actualPrice = getActualPrice(safeItem);
      ...
      <div className="bg-white rounded-[32px] border border-gray-100 p-6 shadow-sm mt-6">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <button
            ...
            className="w-full sm:w-auto px-12 py-3 bg-brand-primary text-sm text-white rounded-full font-semibold shadow-xl shadow-brand-primary/20 hover:bg-brand-dark transition-all active:scale-[0.98]"
          >
            Оформити замовлення
          </button>
        </div>
